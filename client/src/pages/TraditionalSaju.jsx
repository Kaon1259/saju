...
const MAIN_MENUS = [
  ...
  { path: '/biorhythm', icon: '📊', label: '바이오리듬', desc: '오늘의 컨디션 체크', color: '#2196F3', cost: 5 },
  { path: '/constellation', icon: '⭐', label: '별자리 운세', desc: '12궁 별자리 운세', color: '#FF9800', cost: 1 },
  { path: '/dream', icon: '🌙', label: '꿈해몽', desc: 'AI 꿈 해석', color: '#6C3483', cost: 5 },
];

const TIME_MENUS = [
  { path: '/year-fortune', icon: '🎊', label: '신년 운세', desc: '올해의 운세', color: '#E74C3C', cost: 5 },
  { path: '/monthly-fortune', icon: '📅', label: '월별 운세', desc: '12개월 분석', color: '#3498DB', cost: 5 },
  { path: '/weekly-fortune', icon: '📆', label: '주간 운세', desc: '이번 주 7일', color: '#27AE60', cost: 5 },
  { path: '/special?tab=time&mode=timeblock', icon: '🌅', label: '시간별 운세', desc: '시간대별 분석', color: '#9B59B6', cost: 5 },
];
