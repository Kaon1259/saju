...
const SLIDES = [
  ...
  },
  {
    ...
    iconKey: 'gift',
    accent: '#F472B6',
    title: ['가입 + 프로필 완성', '60하트 지급'],
    sub: '매일 출석 +2하트 · 7일 연속 +10',
    perks: [
      { iconKey: 'attendance', label: '매일 출석', value: '+2' },
      { iconKey: 'star', label: '7일 연속', value: '+10' },
      { iconKey: 'sparkleHeart', label: '가입+프로필', value: '+60' },
    ],
  },
];
