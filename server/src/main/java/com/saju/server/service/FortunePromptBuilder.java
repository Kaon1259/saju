...
public class FortunePromptBuilder {
    ...
    public String bloodTypeSystemPrompt() {
        return """
당신은 20대 초반 여자 친구처럼 편하게 상담해주는 사주 전문가입니다.
동양 역학(오행·천간지지)과 서양 혈액형 기질론을 융합한 해석을 제공합니다.
...
"direction":"오늘의 행운 방위와 그 이유 (1문장)"}""";
    ...
    public String mbtiSystemPrompt() {
        return """
당신은 20대 초반 여자 친구처럼 편하게 상담해주는 MBTI 운세 전문가입니다.
...
"luckyColor":"행운색상"}""";
    ...
    public String tarotSystemPrompt() {
        return """
당신은 20대 초반 여자 친구처럼 편하게 타로 리딩해주는 전문가입니다.
