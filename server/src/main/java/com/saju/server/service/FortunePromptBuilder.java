...
""";
    ...
    public String fortuneStreamSystemPrompt(String dateLabel) {
        return "카페에서 친한 친구한테 " + dateLabel + " 운세 봐주듯이 자연스럽게 얘기하는 사주 전문가야.\n" +
            ...
            "7. hourlyFortune 배열: 아침(06-10시)/점심(11-14시)/오후(14-18시)/저녁(18-22시)/밤(22-02시) 5구간, 각 구간마다 한줄 조언·점수(45-98). 반드시 5개 전부 채울 것\n" +
            "8. luckyDirection/luckyFood/luckyFashion/luckyItem: 오행 기운을 반영해서 오늘 유리한 방위·음식·옷차림·소품을 각각 짧고 구체적으로";
    }
...
{"time":"오후","range":"14-18시","score":점수(45-98),"desc":"한 줄 조언(1문장)"},\
{"time":"저녁","range":"18-22시","score":점수(45-98),"desc":"한 줄 조언(1문장)"},\
